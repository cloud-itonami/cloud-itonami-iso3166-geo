...
`cloud-itonami-iso3166-geo` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Georgian-licensed counsel or a registered agent for whatever licensed
representation the law of Georgia requires for public-procurement
filings.
